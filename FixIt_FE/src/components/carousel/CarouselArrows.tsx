...
function LeftIcon({ icon = 'eva:arrow-ios-forward-fill', isRTL }: TIcon) {
  return (
    <Iconify
      icon={icon}
      sx={{
...
function RightIcon({ icon = 'eva:arrow-ios-forward-fill', isRTL }: TIcon) {
  return (
    <Iconify
      icon={icon}
      sx={{
...
interface ICarouselArrows extends StackProps {
  shape?: 'circular' | 'rounded';
  filled?: boolean;
