...
const Header = ({ barber, onClose }: { barber: TBarbershop | null; onClose: () => void }) => {
    ...
    >
      ...
      >
        ...
        <Box
          ...
          sx={{
            display: 'flex', color: 'secondary.dark', alignItems: 'center', mb: 3, mt: 1, textDecoration: 'none'
          }}>
        ...
        <Box>
          <IconButton
            ...
            sx={{ backgroundColor: 'secondary.lighter', color: 'secondary.darker', borderRadius: 4 }}>
          ...
          {barber?.instagramLink &&
              <IconButton
                  ...
                  sx={{ backgroundColor: 'secondary.lighter', color: 'secondary.darker', ml: 2, borderRadius: 4 }}>
          ...
          {barber?.facebookLink &&
              <IconButton
                  ...
                  sx={{ backgroundColor: 'secondary.lighter', color: 'secondary.darker', borderRadius: 4, ml: 2 }}>
