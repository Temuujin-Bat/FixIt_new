...
// Components
import { CreatorInfo, Gallery, Links, PaymentDetails, Title } from "..";
  ...
  return (
    ...
    >
      ...
      <Box padding={isScreenXS ? 0 : 4}>
        <Title titleNumber={4} title="דרכי הרשמה ותשלום" color="error.main" />
      ...
      {/* Gallery */}
      <Box padding={isScreenXS ? 0 : 4}>
        <Title titleNumber={5} title="תמונות לאירוע" color="error.main" />
      ...
      <Box padding={isScreenXS ? 0 : 4} mb={2}>
        <Title titleNumber={6} title="דרכי תקשורת" color="error.main" />
      ...
      {/* Links */}
      <Box padding={isScreenXS ? 0 : 4} mb={2}>
        <Title titleNumber={7} title="דרכי תקשורת" />
